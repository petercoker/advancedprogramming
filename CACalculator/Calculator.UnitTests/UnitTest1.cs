...
namespace Calculator.UnitTests
{
    ...
    public class CalculatorTests
    {
        ...
        [DataRow(10.1, 10.1, -102.01, DisplayName = "Multiply positive double numbers with value")]
        [DataRow(-10.1, -10.1, 102.01, DisplayName = "Multiply negative numbers with value")]
        public void Multiply_UserMultiplyTwoNonWholeNumbers_ReturnsNegativeNumber(double a, double b,
        ...
        [DataTestMethod]
        [Ignore]
        [DataRow(5.0, 0.08715574274765817355806427083747, DisplayName =
            "Sin different positive double number with no value")]
        ...
        [DataRow(-5.1, -0.08889429686644151920780187046343, DisplayName =
            "Sin different negative double number with value")]
        ...
        [DataRow(-5.1, -0.08889429686644151920780187046343, DisplayName =
            "Cos different negative double number with value")]
        ...
        public void Exp_WhenCalled_ReturnsPositiveNumber(double a, double expectedResult)
        {
            // Act
